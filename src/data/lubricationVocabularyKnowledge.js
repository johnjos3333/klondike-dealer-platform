...
export const lubricationVocabularyKnowledge = {
  dripOil: {
    ...
    normalizedCategory:
      "Deep Well Pump Oil / drip-feed lubricating oil; also light machine / bearing oil or ISO circulating oil when the customer means a general drip-feed lubricator (application-specific)",
    explanation:
      "“Drip oil” usually describes how oil is applied—slow gravity or wick feed to plain bearings, chains, or slideways—not a single ASTM product class. In KLONDIKE language and many field conversations, “drip oil” is also used loosely for **Deep Well Pump Oil** (vertical turbine, line-shaft, or pump-jack lubrication). The correct fluid is whatever viscosity and oxidation/corrosion package the OEM or equipment tag specifies—well service vs industrial drip feed are different conversations on the PDS.",
    relatedApplications: [
      "Deep well, line-shaft, and pump-jack installations where crews call the drum “drip oil”",
    ...
    likelyIndustries: [
      ...
      "municipal water",
      "oil & gas water handling",
      "manufacturing",
      "wood products",
      "general industrial",
      "legacy machine shops",
    ],
    likelyKlondikeCategories: [
      "KLONDIKE Deep Well Pump Oil—when the customer means well or pump-jack service; confirm ISO and OEM on PDS",
      "Industrial circulating / way-type ISO oils where viscosity matches tag for general drip feeds",
      "R&O or lightly additized ISO grades per OEM—not assumed without PDS confirmation",
    ],
    commonMisunderstandings: [
      "“Drip oil” is often field slang—confirm whether they mean **Deep Well Pump Oil** (well/pump-jack) or a **general drip-feed lubricator** (machine tool, chain, way) before matching any SKU",
      "Treating “drip oil” as interchangeable with hydraulic AW or engine oil",
      "Assuming one viscosity fits every drip sight glass or every well pump program",
    ],
    questionsToAsk: [
      "Is this for a deep well pump or a general drip-feed lubricator?",
      "What viscosity is currently being used?",
      "Is there an OEM or equipment tag requirement?",
      "Is this exposed to water, dust, or outdoor conditions?",
    ],
    cautionNotes: [
      "Match product name, viscosity, and additive class to the application on the current PDS—do not substitute hydraulic or engine oil without OEM confirmation.",
      "Well pump and industrial drip systems are not interchangeable; verify equipment type and nameplate fluid before quoting.",
    ],
    keywords: [
      "drip",
      "drip feed",
